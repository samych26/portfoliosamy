...
if (isset($_POST['send'])) {
  // Extraction et sanitisation des données du formulaire
  ...
  <section id="profile">
    ...
    <div class="section__text">
      ...
      <div class="btn-container">
        <button class="btn btn-color-2" onclick="window.open('./assets/CV.pdf', '_blank')">
          Download CV
        </button>
      </div>
    </div>
    ...
    <div class="experience-details-container">
      <div class="about-containers">
        <div class="details-container color-container">
          <div class="article-container">
            <img src="./assets/Rectangle 11.png" alt="Project 1" class="project-img" />
          </div>
          ...
          <div class="btn-container">
            <button class="btn btn-color-2 project-btn" onclick="window.open('https://github.com/Paranoid-Pufferfish/Binary-Echoes')">
              Github
            </button>
          </div>
        </div>
        <div class="details-container color-container">
          <div class="article-container">
            <img src="./assets/Pong-game.ico" alt="Project 2" class="project-img" />
          </div>
          ...
          <div class="btn-container">
            <button class="btn btn-color-2 project-btn" onclick="window.open('https://github.com/samych26/Pong')">
              Github
            </button>
          </div>
        </div>
